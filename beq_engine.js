...
{
	if (module.exports.cntCalls == undefined)
		module.exports.cntCalls = 0;
	else
		module.exports.cntCalls++;
	...
	switch (beqTalk.command)
	{
		case 'yIngu\'':
		   ...
		   tmpTxt += "I have been called " + module.exports.cntCalls + " times so far!" + beqTalk.newline;
