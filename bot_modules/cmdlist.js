...
+ 'simple - only the bare minimum, also remove original request<BR>'
+ 'source - show sources if available<BR>'
+ 'cat - show categories, if available<BR>'
+ '<BR>'
+ 'If you want to look for more than one word at the same time (one language only!), then you can use the pipe(|) operator:<BR>'
+ '*?tlh tlhIngan|Hol*<BR>'
+ 'will translate both tlhIngan and Hol<BR>'
...
+ 'Replace multi-character letters with single-character letters or even their unicode representation for pIqaD.<BR>'
+ 'Use *!recode encoding* **text-to-encode**<BR>'
+ 'Or *!recode help* for detailed instructions<BR>'
+ '<BR>'
+ 'yIcha\' - show prefix or suffix list, details will come later<BR>'
+ '*Categorization* (Use $)<BR>'
+ '**To be added after complete rework!**'
+ '<BR>'
+ '<BR>'
+ '**Other stuff ** (Use !)<BR>'
