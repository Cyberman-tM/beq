...
module.exports.de += "3) Das ist ein privater Server, niemand hat ein gottgebenenes 'Recht' hier zu sein." + "\n";
module.exports.de += "\n";
module.exports.de += "==>Denkt an Regel 1 und es wird keine Probleme geben. Aber wenn jemand Probleme macht, siehe Regel 3." + "\n";
module.exports.de += "\n";
module.exports.de += "\n";

module.exports.en = "To be translated...\n";
